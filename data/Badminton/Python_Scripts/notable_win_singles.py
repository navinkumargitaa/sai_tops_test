...
if not summary_2024.empty:
    summary_2024.drop(columns=["parsed_date"]).to_csv("tournament_summary_2024.csv", index=False)
...
if not summary_2025.empty:
    summary_2025.drop(columns=["parsed_date"]).to_csv("tournament_summary_2025.csv", index=False)
