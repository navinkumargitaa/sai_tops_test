...
from orm.shooting.shooting_ranking_distribution import AthleteRankCategoryViz, Base

# Import database engine
from model.shooting.database import sai_db_engine

from services.shooting.analysis import populate_athlete_rank_distribution
...
def main():
    ...
    Base.metadata.create_all(bind=sai_db_engine, tables=[AthleteRankCategoryViz.__table__])
    ...
    rank_df = populate_athlete_rank_distribution()
