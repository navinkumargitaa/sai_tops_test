...
from services.badminton.analysis_new import process_doubles_tournament_finishes
    ...
    try:
        ...
        records = [
            BadmintonDoublesTournamentFinishes(
                ...
                Junior_LT_R32=int(row["Junior_LT_R32"]),
                ...
                Super100_LT_R32=int(row["Super 100_LT_R32"]),
                Super100_R32=int(row["Super 100_R32"]),
                Super100_R16=int(row["Super 100_R16"]),
                Super100_QF=int(row["Super 100_QF"]),
                Super100_SF=int(row["Super 100_SF"]),
                Super100_F=int(row["Super 100_F"]),

                Super300_LT_R32=int(row["Super 300_LT_R32"]),
                Super300_R32=int(row["Super 300_R32"]),
                Super300_R16=int(row["Super 300_R16"]),
                Super300_QF=int(row["Super 300_QF"]),
                Super300_SF=int(row["Super 300_SF"]),
                Super300_F=int(row["Super 300_F"]),

                Super500_LT_R32=int(row["Super 500_LT_R32"]),
                Super500_R32=int(row["Super 500_R32"]),
                Super500_R16=int(row["Super 500_R16"]),
                Super500_QF=int(row["Super 500_QF"]),
                Super500_SF=int(row["Super 500_SF"]),
                Super500_F=int(row["Super 500_F"]),

                Super750_LT_R32=int(row["Super 750_LT_R32"]),
                Super750_R32=int(row["Super 750_R32"]),
                Super750_R16=int(row["Super 750_R16"]),
                Super750_QF=int(row["Super 750_QF"]),
                Super750_SF=int(row["Super 750_SF"]),
                Super750_F=int(row["Super 750_F"]),

                Super1000_LT_R32=int(row["Super 1000_LT_R32"]),
                Super1000_R32=int(row["Super 1000_R32"]),
                Super1000_R16=int(row["Super 1000_R16"]),
                Super1000_QF=int(row["Super 1000_QF"]),
                Super1000_SF=int(row["Super 1000_SF"]),
                Super1000_F=int(row["Super 1000_F"]),

                Grade1_LT_R32=int(row["Grade 1_LT_R32"]),
